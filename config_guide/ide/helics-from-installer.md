...
- For steps on navigating HELICS installer and understanding the directories please go to [helics-installer-guide](/install-guide/helics-installer-guide.md)
...
1. In order to get to the Makemake options, you will go to Project/Properties > OMNeT++ > Makemake.
  ...
  <img alt="config-file1" src=/config_guide/ide/images/makemake1.png width="550"> <br>
...
This will open up to a window. Navigate to Compile:
  ...
  <img alt="config-file2" src=/config_guide/ide/images/makemake2.png width="550"> <br>

3. Here you will add the include directories that hold the HELICS header files (if you are unclear of which directories these are please check [helics-installer-guide](/install-guide/helics-installer-guide.md):

    <img alt="config-file3" src=/config_guide/ide/images/makemake3.png width="550"> <br>
...
4. Once that is done, do not exit and navigate to Link tab. Here you will add the name of the HELICS library without the suffix:
  ...
  <img alt="config-file4" src=/config_guide/ide/images/makemake4.png width="550"> <br>
...
1. On left navigation bar of Properties, navigate C/C++ General > Paths and Symbols:
    ...
    <img alt="config-file5" src=/config_guide/ide/images/pathsandsymbol1.png width="550"> <br>
...
Make sure to check 'Add to all configurations' and 'Add to all languages'
  - This will save you the trouble of having to add the directories again in GNU C and GNU C++
    ...
    <img alt="config-file6" src=/config_guide/ide/images/pathsandsymbol2_include.png width="550">

    <img alt="config-file7" src=/config_guide/ide/images/pathsandsymbol2_helics.png width="550">

    <img alt="config-file8" src=/config_guide/ide/images/pathsandsymbol2_cpp98.png width="550">
...
3. Once the Include directories have been added, navigate to Libraries Tab. Here you will add the full path to the HELICS library:
    ...
    <img alt="config-file9" src=/config_guide/ide/images/pathsandsymbol3.png width="550"> <br>

    <img alt="config-file10" src=/config_guide/ide/images/pathsandsymbol3_lib.png width="550"> <br>

    <img alt="config-file11" src=/config_guide/ide/images/pathsandsymbol3_lib1.png width="550"> <br>

4. Navigate to the Library Paths Tab, and add the library directory:

    <img alt="config-file12" src=/config_guide/ide/images/pathsandsymbol4.png width="550"> <br>

    <img alt="config-file13" src=/config_guide/ide/images/pathsandsymbol4_lib.png width="550"> <br>

    <img alt="config-file14" src=/config_guide/ide/images/pathsandsymbol4_lib2.png width="550"> <br>
...
1. Right click on project name > Import ...
    ...
    <img alt="config-file15" src=/config_guide/ide/images/import_dll1.PNG width="550"> <br>

2. General > File System

    <img alt="config-file16" src=/config_guide/ide/images/import_dll2.PNG width="550"> <br>

3. Choose the directory that holds the HELICS dynamically-linked library then choose the library to import:

    <img alt="config-file17" src=/config_guide/ide/images/import_dll3.png width="550"> <br>

4. How the Project Explorer should look after the dynamically-linked library is added:

    <img alt="config-file18" src=/config_guide/ide/images/import_dll4.png width="550"> <br>
